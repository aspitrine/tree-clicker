import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, useSSRContext, computed, toRef, unref, inject, h, resolveComponent, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, useAttrs, toValue as toValue$1, onUnmounted, withCtx, createTextVNode, toDisplayString, createApp, effectScope, reactive, isRef, renderSlot, readonly, provide, onErrorCaptured, onServerPrefetch, hasInjectionContext, isReadonly, openBlock, createBlock, createCommentVNode, isShallow, isReactive, toRaw } from 'vue';
...
import { d as useRuntimeConfig$1, h as createError$1, l as createHooks, m as getRequestHeader, n as sanitizeStatusCode, o as setCookie, p as getCookie, q as deleteCookie } from '../nitro/node-server.mjs';
import { getActiveHead } from 'unhead';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderSuspense, ssrRenderClass } from 'vue/server-renderer';
import 'fs';
import 'path';
...
const mr = Symbol.toStringTag, bi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ns = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Hs = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./_nuxt/multipart-parser-pm-uHLNh.mjs');
...
const unhead_QMEaGS5kii = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_5d38yIkfJT = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_uwSTvxsY8o = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-DufmwUwD.mjs').then((r) => r.default));
...
const colors_is188am0ss = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_QMEaGS5kii,
  router_5d38yIkfJT,
  revive_payload_server_uwSTvxsY8o,
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.13.0_nuxt@3.10.1_vite@5.0.12_vue@3.4.16/node_modules/@nuxt/ui/dist/runtime/components/elements/Link.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-icon@0.6.8_nuxt@3.10.1_vite@5.0.12_vue@3.4.16/node_modules/nuxt-icon/dist/runtime/Icon.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-adda1fdc"]]);
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.13.0_nuxt@3.10.1_vite@5.0.12_vue@3.4.16/node_modules/@nuxt/ui/dist/runtime/components/elements/Icon.vue");
...
const _sfc_main$3 = defineComponent({
  ...
  setup(props, { slots }) {
    const { ui: ui2, attrs } = useUI("button", toRef(props, "ui"), config);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.13.0_nuxt@3.10.1_vite@5.0.12_vue@3.4.16/node_modules/@nuxt/ui/dist/runtime/components/elements/Button.vue");
...
function useGame() {
  ...
  const getCurrentDammageAmount = (auto) => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { game, click, isClicked: isClicked2, buyItem, getItemPrice } = useGame();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UButton = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid h-screen grid-cols-2" }, _attrs))}><section class="flex h-full items-center justify-center"><div class="text-center"><h1 class="text-4xl font-bold"> Clique sur l&#39;arbre </h1><p class="text-lg"> Clique sur l&#39;arbre pour récupérer du bois </p><p class="text-lg"> Bois: ${ssrInterpolate(unref(game).money)}</p>`);
      _push(ssrRenderComponent(_component_UButton, {
        icon: "i-mdi-pine-tree",
        variant: "ghost",
        class: {
          shake: unref(isClicked2)
        },
        ui: {
          icon: {
            base: "h-64 w-64"
      ...
      _push(`</div></section><section class="flex flex-col gap-2 bg-gray-700 p-2"><!--[-->`);
      ssrRenderList(unref(game).items, (item) => {
        _push(`<div><h3 class="text-xl font-bold">${ssrInterpolate(item.name)}</h3><p class="font-bold text-blue-500"> Level: ${ssrInterpolate(item.level)}</p><p>Dégât: ${ssrInterpolate(item.baseDamage * item.level)}</p><p>Price: ${ssrInterpolate(unref(getItemPrice)(item))}</p>`);
        _push(ssrRenderComponent(_component_UButton, {
          color: item.level === 0 ? "green" : "blue",
          disabled: unref(game).money < unref(getItemPrice)(item),
          onClick: ($event) => unref(buyItem)(item)
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(item.level === 0 ? "Acheter" : "Améliorer")}`);
            } else {
              return [
                createTextVNode(toDisplayString(item.level === 0 ? "Acheter" : "Améliorer"), 1)
              ];
            }
          }),
          _: 2
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-5HJoqVaT.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-MSxuppG5.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.10.1_eslint@8.56.0_typescript@5.3.3_vite@5.0.12/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-E9aMAECE.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.10.1_eslint@8.56.0_typescript@5.3.3_vite@5.0.12/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Bn as B, _export_sfc as _, __nuxt_component_0$3 as a, useAppConfig as b, createError as c, br as d, entry$1 as default, resolveIconName as r, useHead as u };
